...
{
    public partial class LoginGarcom : System.Web.UI.Page
    {
        ...
        protected async void login_click(object Source, EventArgs e)
        {
            ...
            {
                if (x.Usuario == TextBoxUsuario.Text && ValidatePassword(TextBoxSenha.Text, x.Senha) && x.Garcom == true)
                {
                    Session["Login"] = TextBoxUsuario.Text;
                    Session["idRest"] = x.Restaurante_id;
                    Session["Permissao"] = "Garcom";
