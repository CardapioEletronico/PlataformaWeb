...
namespace RestauranteWeb
{
	...
	public partial class Banco1DataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteRestaurante(Restaurante instance);
		...
		public Banco1DataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public Banco1DataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public Banco1DataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public Banco1DataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnRestaurante_IdChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Restaurante_AdminRest", Storage="_Restaurante", ThisKey="Restaurante_Id", OtherKey="Id", IsForeignKey=true)]
    ...
    partial void OnDescricaoChanged();
		...
		public EntitySet<AdminRest> AdminRests
		{
			get
			{
