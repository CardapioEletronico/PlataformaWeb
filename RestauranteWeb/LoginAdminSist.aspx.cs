...
{
    public partial class LoginAdminSist : System.Web.UI.Page
    {
        ...
        protected async void login_click(object Source, EventArgs e)
        {
            ...
            foreach (Models.AdminSistema x in obj)
            {
                if (x.Usuario == TextBoxUsuario.Text && ValidatePassword(TextBoxSenha.Text, x.Senha))
                {
                    ...
                    Response.Write("<script>self.location='WebCRUDRestaurante.aspx'; </script>");
                    return;
                }
            }
